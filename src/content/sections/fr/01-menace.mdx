  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Volontaire, les plateformes <em>peuvent</em> scanner</td>
        <td>Obligatoire via « ordres de détection » et « mesures d'atténuation des risques »</td>
      </tr>
      <tr>
        <td>Qui est visé</td>
        <td>Surtout services US non chiffrés : Gmail, Messenger/Instagram, Skype, Snapchat, iCloud Mail, Xbox</td>
        <td><strong>Toutes</strong> les plateformes, y compris les messageries chiffrées de bout en bout</td>
      </tr>
    </tbody>
  </table>
</div>
