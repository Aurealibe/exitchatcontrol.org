...
<div class="tablewrap">
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>Scanning</td>
        <td>Voluntary, platforms <em>may</em> scan</td>
        <td>Mandatory via "detection orders" and "risk-mitigation measures"</td>
      </tr>
      <tr>
        <td>Who</td>
        <td>Mostly unencrypted US services: Gmail, Messenger/Instagram, Skype, Snapchat, iCloud Mail, Xbox</td>
        <td><strong>All</strong> platforms, including end-to-end encrypted messengers</td>
      </tr>
    </tbody>
  </table>
</div>
